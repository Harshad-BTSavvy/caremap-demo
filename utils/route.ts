...
export const ROUTES = {
  ...
  HOSPITALIZATION: `${ROUTE_PREFIX.MEDICAL_HISTORY}/(medicalHistoryTab)/hospitalization` as const,
  SURGERIES_AND_PROCEDURES: `${ROUTE_PREFIX.MEDICAL_HISTORY}/(medicalHistoryTab)/surgeriesAndProcedures` as const,
  POST_DISCHARGE_INSTRUCTIONS: `${ROUTE_PREFIX.MEDICAL_HISTORY}/(medicalHistoryTab)/postDischargeInstructions` as const,
} as const;
